function groupStageSliders () {
	...
	slider.oninput = function() {
		...
		var f = "<iframe width='350' height='400' frameborder='0' scrolling='no' src='https://fnagano.github.io/worldcup2018/Acompanhamento/Next_matches/?file_path=data/" + data + ".json' align='middle'></iframe>";
		next_matches[0].innerHTML = f;
		
		// Modificando tabela de oitavas
		var oitavas = document.getElementsByClassName("oitavas");
		var f = "<iframe width='400' height='200' frameborder='0' scrolling='no' src='https://fnagano.github.io/worldcup2018/Acompanhamento/Matamata/Oitavas2/?file_path=data/" + data + ".json' align='middle'></iframe>";
	...
	// Modificando tabela Next Match
	var next_matches = document.getElementsByClassName("next_matches");
	var f = "<iframe width='400' height='350' frameborder='0' scrolling='no' src='https://fnagano.github.io/worldcup2018/Acompanhamento/Next_matches/?file_path=data/" + data + ".json' align='middle'></iframe>";
	next_matches[0].innerHTML = f;
