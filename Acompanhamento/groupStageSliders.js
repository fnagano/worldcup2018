function groupStageSliders () {
	...
	// Modificando tabela de oitavas
	var oitavas = document.getElementsByClassName("oitavas");
	var f = "<iframe width='300' height='200' frameborder='0' scrolling='no' src='https://fnagano.github.io/worldcup2018/Acompanhamento/Matamata/Oitavas/?file_path=data/" + data + ".json' align='middle'></iframe>";
	oitavas[0].innerHTML = f;
